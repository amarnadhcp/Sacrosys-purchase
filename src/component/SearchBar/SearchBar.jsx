    ...
    <div className="flex flex-wrap overflow-hidden justify-between items-center bg-white my-4">
      <div className="flex">
        <label
          ...
          className="mx-4 text-gray-800 font-Inter  text-sm mt-3 font-inter "
        >
          Search
        </label>
        <div className="flex flex-wrap" >
          <div className="relative flex items-center mr-4 w-full md:w-auto">
            <input
              id="search-input"
              className="w-full py-2 pl-2 pr-10 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-purple-400"
              type="text"
